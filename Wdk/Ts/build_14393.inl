    ...
    typedef struct _KTHREAD
    {
        ...
        union
        {
            struct /* bitfield */
            {
                ...
                UINT32 RestrictedGuiThread : 1; /* bit position: 19 */
                UINT32 ThreadFlagsSpare : 4; /* bit position: 20 */
        ...
        UINT64 NpxState;
#endif
    } KTHREAD, *PKTHREAD; /* size: 0x05e0 */ /* size: 0x0348 */
    static_assert(sizeof(KTHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x05e0 : 0x0348));
    ...
    typedef struct _ETHREAD
    {
        ...
        union
        {
            ...
            struct /* bitfield */
            {
                ...
                UINT32 ReservedCrossThreadFlags : 12; /* bit position: 20 */
            }; /* bitfield */
        }; /* size: 0x0004 */
        union
        {
            ...
            struct /* bitfield */
            {
                ...
                UINT32 ReservedSameThreadPassiveFlags : 23; /* bit position: 9 */
            }; /* bitfield */
        }; /* size: 0x0004 */
        union
        {
...
#endif
        UINT32 ReadyTime;
    } ETHREAD, *PETHREAD; /* size: 0x07e0 */ /* size: 0x0460 */
    static_assert(sizeof(ETHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x07e0 : 0x0460));
