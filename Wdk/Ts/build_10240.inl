    ...
    typedef struct _KTHREAD
    {
        ...
        union
        {
            struct /* bitfield */
            {
                ...
                UINT32 ThreadFlagsSpare0 : 1; /* bit position: 2 */
                ...
                UINT32 CommitFailTerminateRequest : 1; /* bit position: 17 */
                UINT32 ProcessStackCountDecremented : 1; /* bit position: 18 */
                UINT32 ThreadFlagsSpare : 5; /* bit position: 19 */
        ...
        UINT64 NpxState;
#endif
    } KTHREAD, *PKTHREAD; /* size: 0x05d8 */ /* size: 0x0348 */
    static_assert(sizeof(KTHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x05d8 : 0x0348));
    ...
    typedef struct _ETHREAD
    {
        ...
        union
        {
            ...
            struct /* bitfield */
            {
                ...
                UINT32 ReservedCrossThreadFlags : 14; /* bit position: 18 */
            }; /* bitfield */
        }; /* size: 0x0004 */
        union
        {
            ...
            struct /* bitfield */
            {
                ...
                UINT32 RespectIoPriority : 1; /* bit position: 5 */
                UINT32 ReservedSameThreadPassiveFlags : 26; /* bit position: 6 */
            }; /* bitfield */
        }; /* size: 0x0004 */
        union
        {
        ...
        volatile UINT32 CmCellReferences;
        union
        {
        ...
        struct _ESILO* Silo;
    } ETHREAD, *PETHREAD; /* size: 0x07c0 */ /* size: 0x0458 */
    static_assert(sizeof(ETHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x07c0 : 0x0458));
