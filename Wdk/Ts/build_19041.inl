...
namespace wdk::build_19041
{
    ...
    typedef struct _KTHREAD
    {
        ...
        union
        {
            struct /* bitfield */
            {
                UINT32 ThreadFlagsSpare : 2; /* bit position: 0 */
                ...
                UINT32 ThreadFlagsSpare2 : 1; /* bit position: 23 */
        ...
        union
        {
            ...
            struct /* bitfield */
            {
                UINT32 BamQosLevel : 8; /* bit position: 0 */
                UINT32 ThreadFlags2Reserved : 24; /* bit position: 8 */
            }; /* bitfield */
        }; /* size: 0x0004 */
        //VOID* Spare21;
#else
        ...
        UINT8 PriorityFloorCountsReserved[16];
        ...
        union
        {
            volatile INT32 ThreadFlags3;
            struct /* bitfield */
            {
#if _X86_
                UINT32 BamQosLevel : 8; /* bit position: 0 */
#else
                UINT32 ThreadFlags3Reserved : 8; /* bit position: 0 */
#endif
                UINT32 PpmPolicy : 2; /* bit position: 8 */
                UINT32 ThreadFlags3Reserved2 : 22; /* bit position: 10 */
            }; /* bitfield */
        }; /* size: 0x0004 */
#ifdef _WIN64
        ...
        UINT32 ReservedPreviousReadyTimeValue;
        ...
        union
        {
            ...
            struct
            {
                ...
                UINT64 InGlobalUpdateVpThreadPriorityList;
            }; /* size: 0x0010 */
        }; /* size: 0x0010 */
        INT32 SchedulerAssistPriorityFloor;
        UINT32 Spare28;
#else
        UINT32 Spare29[3];
#endif
        SIZE_T EndPadding[5];
    } KTHREAD, * PKTHREAD; /* size: 0x0430 */ /* size: 0x0280 */
    static_assert(sizeof(KTHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x0430 : 0x0280));
    ...
    typedef struct _ETHREAD
    {
        ...
        union {
            ...
            struct
            {
                ...
                struct                                          /* bitfield */
                {
                    ...
                    UINT8 AllowUserWritesToExecutableMemory : 1;   /* bit position: 4 */
                    UINT8 AllowKernelWritesToExecutableMemory : 1; /* bit position: 5 */
                    UINT8 OwnsVadShared : 1;                       /* bit position: 6 */
                };                                                 /* bitfield */
            };                                                     /* size: 0x0002 */
        };                                                         /* size: 0x0004 */
        ...
        UINT32 PerformanceCountLowReserved;
        INT32 PerformanceCountHighReserved;
        ...
        INT32 __PADDING__[1];
#endif
    } ETHREAD, * PETHREAD; /* size: 0x0898 */ /* size: 0x04e0 */
    static_assert(sizeof(ETHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x0898 : 0x04e0));
