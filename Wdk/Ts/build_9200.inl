...
namespace wdk::build_9200
{
    ...
    typedef struct _KTHREAD
    {
        ...
        union
        {
            struct /* bitfield */
            {
                ...
                UINT32 CodePatchInProgress : 1; /* bit position: 6 */
                UINT32 UserStackWalkActive : 1; /* bit position: 7 */
                UINT32 ApcInterruptRequest : 1; /* bit position: 8 */
                UINT32 QuantumEndMigrate : 1; /* bit position: 9 */
                UINT32 UmsDirectedSwitchEnable : 1; /* bit position: 10 */
                UINT32 TimerActive : 1; /* bit position: 11 */
                UINT32 SystemThread : 1; /* bit position: 12 */
                UINT32 ProcessDetachActive : 1; /* bit position: 13 */
                UINT32 CalloutActive : 1; /* bit position: 14 */
                UINT32 ScbReadyQueue : 1; /* bit position: 15 */
                UINT32 ApcQueueable : 1; /* bit position: 16 */
                UINT32 ReservedStackInUse : 1; /* bit position: 17 */
                UINT32 UmsPerformingSyscall : 1; /* bit position: 18 */
                UINT32 Reserved : 13; /* bit position: 19 */
            }; /* bitfield */
            INT32 MiscFlags;
        }; /* size: 0x0004 */
        union
        {
            struct /* bitfield */
            {
                ...
                UINT32 ChargeOnlyGroup : 1; /* bit position: 8 */
                ...
                UINT32 ExplicitIdealProcessor : 1; /* bit position: 12 */
                UINT32 FreezeCount : 1; /* bit position: 13 */
                UINT32 EtwStackTraceApcInserted : 8; /* bit position: 14 */
                UINT32 ReservedFlags : 10; /* bit position: 22 */
            }; /* bitfield */
...
#endif
    } KTHREAD, *PKTHREAD; /* size: 0x0348 */ /* size: 0x01e8 */
    static_assert(sizeof(KTHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x0348 : 0x01e8));
    ...
    } ETHREAD, *PETHREAD; /* size: 0x04c8 */ /* size: 0x02c0 */
    static_assert(sizeof(ETHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x04c8 : 0x02c0));
