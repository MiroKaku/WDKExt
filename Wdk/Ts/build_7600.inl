...
namespace wdk::build_7600
{
    ...
    typedef struct _KTHREAD
    {
        ...
        union
        {
            struct /* bitfield */
            {
                ...
                UINT32 Reserved : 19; /* bit position: 13 */
            }; /* bitfield */
            INT32 MiscFlags;
        }; /* size: 0x0004 */
        union
        ...
        union
        {
            struct /* bitfield */
            {
                ...
                volatile UINT32 ReservedFlags : 22; /* bit position: 10 */
            }; /* bitfield */
    ...
    } KTHREAD, *PKTHREAD; /* size: 0x0360 */ /* size: 0x0200 */
    static_assert(sizeof(KTHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x0360 : 0x0200));
    ...
    typedef struct _ETHREAD
    {
        ...
        union
        {
            ...
            struct /* bitfield */
            {
                ...
                UINT32 SystemThread : 1; /* bit position: 4 */
    ...
    } ETHREAD, *PETHREAD; /* size: 0x04a0 */ /* size: 0x02b8 */
    static_assert(sizeof(ETHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x04a0 : 0x02b8));
