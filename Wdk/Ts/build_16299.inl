...
/*
 * PDB file: \Nt-Crucial-Modules\Ntoskrnl\10.0.16299.755\
...
namespace wdk::build_16299
{
...
#endif
    } KTHREAD, *PKTHREAD; /* size: 0x05f0 */ /* size: 0x0350 */
    static_assert(sizeof(KTHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x05f0 : 0x0350));
    ...
    typedef struct _ETHREAD
    {
        ...
        union
        {
            ...
            struct /* bitfield */
            {
                ...
                UINT32 ReservedSameThreadPassiveFlags : 21; /* bit position: 11 */
            }; /* bitfield */
        }; /* size: 0x0004 */
        union
        {
    ...
    } ETHREAD, *PETHREAD; /* size: 0x0818 */ /* size: 0x0480 */
    static_assert(sizeof(ETHREAD) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x0818 : 0x0480));
