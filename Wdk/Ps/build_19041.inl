...
namespace wdk::build_19041
{
    enum : UINT32
    {
        NumberOfProcessorPadding = 12,
    };

    using build_18363::NumberOfProcessor;
    SameDefine$(build_18363, KAFFINITY_EX);
    ...
    typedef struct _KPROCESS
    {
...
#ifdef _WIN64
        UINT64 AffinityPadding[NumberOfProcessorPadding];
#endif
        struct _LIST_ENTRY ReadyListHead;
        struct _SINGLE_LIST_ENTRY SwapListEntry;
        volatile struct _KAFFINITY_EX ActiveProcessors;
#ifdef _WIN64
        UINT64 ActiveProcessorsPadding[NumberOfProcessorPadding];
#endif
        union {
            struct /* bitfield */
            {
                ...
                UINT32 DisableQuantum : 1;        /* bit position: 2 */
                ...
                UINT32 VaSpaceDeleted : 1;        /* bit position: 10 */
                UINT32 ReservedFlags : (sizeof(UINT32) * 8) - 11; /* bit position: 11 */
            };                                    /* bitfield */
...
#ifdef _WIN64
        UINT16 ThreadSeedPadding[NumberOfProcessorPadding];
#endif
        UINT16 IdealProcessor[NumberOfProcessor];
#ifdef _WIN64
        UINT16 IdealProcessorPadding[NumberOfProcessorPadding];
#endif
        UINT16 IdealNode[NumberOfProcessor];
#ifdef _WIN64
        UINT16 IdealNodePadding[NumberOfProcessorPadding];
#endif
        ...
        UINT64 UserWaitTime;
        SIZE_T EndPadding[8];
    } KPROCESS, * PKPROCESS; /* size: 0x0438 */ /* size: 0x00e0 */
    static_assert(sizeof(KPROCESS) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x0438 : 0x00e0));
...
#ifdef _WIN64
        INT32 __PADDING__[12];
#endif
    } EPROCESS, * PEPROCESS; /* size: 0x0a40 */ /* size: 0x04c0 */
    static_assert(sizeof(EPROCESS) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x0a40 : 0x04c0));
}
