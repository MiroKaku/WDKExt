    ...
    typedef struct _KPROCESS
    {
        ...
        union
        {
            struct /* bitfield */
            {
                ...
                UINT32 PpmPolicy : 2; /* bit position: 6 */
        ...
        UINT32 ProcessTimerDelay;
#endif
    } KPROCESS, *PKPROCESS; /* size: 0x02d8 */ /* size: 0x00b0 */
    static_assert(sizeof(KPROCESS) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x02d8 : 0x00b0));
    ...
    typedef struct _EPROCESS
    {
        ...
        union
        {
            ...
            struct /* bitfield */
            {
                ...
                UINT32 ProhibitRemoteImageMap : 1; /* bit position: 11 */
                UINT32 ProhibitLowILImageMap : 1; /* bit position: 12 */
                UINT32 SignatureMitigationOptIn : 1; /* bit position: 13 */
                UINT32 DisableDynamicCodeAllowOptOut : 1; /* bit position: 14 */
                UINT32 EnableFilteredWin32kAPIs : 1; /* bit position: 15 */
                UINT32 AuditFilteredWin32kAPIs : 1; /* bit position: 16 */
                UINT32 PreferSystem32Images : 1; /* bit position: 17 */
                UINT32 RelinquishedCommit : 1; /* bit position: 18 */
                UINT32 AutomaticallyOverrideChildProcessPolicy : 1; /* bit position: 19 */
                UINT32 HighGraphicsPriority : 1; /* bit position: 20 */
                UINT32 CommitFailLogged : 1; /* bit position: 21 */
                UINT32 ReserveFailLogged : 1; /* bit position: 22 */
                UINT32 DisableDynamicCodeAllowRemoteDowngrade : 1; /* bit position: 23 */
                UINT32 LoaderIntegrityContinuityEnabled : 1; /* bit position: 24 */
                UINT32 LoaderIntegrityContinuityAudit : 1; /* bit position: 25 */
                UINT32 ControlFlowGuardExportSuppressionEnabled : 1; /* bit position: 26 */
                UINT32 FatalAccessTerminationRequested : 1; /* bit position: 27 */
                UINT32 DisableSystemAllowedCpuSet : 1; /* bit position: 28 */
                UINT32 ControlFlowGuardStrict : 1; /* bit position: 29 */
            }; /* bitfield */
        }; /* size: 0x0004 */
        INT32 DeviceAsid;
        VOID* SvmData;
        ...
        union
        {
            ...
            struct /* bitfield */
            {
                UINT32 PicoCreated : 1; /* bit position: 0 */
                UINT32 RestrictSetThreadContext : 1; /* bit position: 1 */
                UINT32 AddressPolicyFrozen : 1; /* bit position: 2 */
                UINT32 RestrictIndirectBranchPrediction : 1; /* bit position: 3 */
                UINT32 MemoryDisambiguationDisable : 1; /* bit position: 4 */
            }; /* bitfield */
        }; /* size: 0x0004 */
        UINT64 SecurityDomain;
    } EPROCESS, *PEPROCESS; /* size: 0x0820 */ /* size: 0x03f0 */
    static_assert(sizeof(EPROCESS) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x0820 : 0x03f0));
