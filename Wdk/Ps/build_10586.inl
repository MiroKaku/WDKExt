...
/*
 * PDB file: \Nt-Crucial-Modules\Ntoskrnl\10.0.10586.1176\
...
namespace wdk::build_10586
{
    ...
    using build_10240::NumberOfProcessor;
    SameDefine$(build_10240, KAFFINITY_EX);
    SameDefine$(build_10240, KPROCESS);
    ...
    } EPROCESS, *PEPROCESS; /* size: 0x0788 */ /* size: 0x0370 */
    static_assert(sizeof(EPROCESS) == (sizeof(SIZE_T) == sizeof(UINT64) ? 0x0788 : 0x0370));
